...
$marin_blog_content_ordering = get_theme_mod( 'marin_blog_content_ordering', array(  'title','content', 'meta-two' ) );
?>
<!--content-page.php-->
<article id="post-<?php the_ID(); ?>" <?php post_class( 'post-items av-column-4 freshcode-post-items' ); ?>>
    <?php
  /*  $cats = get_the_category(get_the_ID());
    ...
    <?php  freshcode_get_site_recommendation(); ?>
